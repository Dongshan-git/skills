...
| reviewer-fable | fable/low | fable | Read-only review when Sonnet's judgment is not enough; Anthropic reports Fable at low is competitive on cost per task with Sonnet or Opus at higher effort |
