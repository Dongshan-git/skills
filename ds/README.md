...
| `skills/dispatch-policy/SKILL.md` | `~/.claude/skills/dispatch-policy/` | L0-L4 budgets in Opus-equivalent starts (haiku 0.2, sonnet 0.4, opus 1, fable 2), role-to-model routing, Fable gate; independent starts run concurrently; loaded before the first delegation |
